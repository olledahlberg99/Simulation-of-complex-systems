...
fireCount = 0                          # Number of fire events
count = 0
fire_store = []
while len(fire_store) < 5000:
    
    count += 1
    R = 0.01               # get growth rate from GUI
    lightningProbability= 0.2         # get lightning probability from GUI
